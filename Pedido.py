class Pedido:
    def __init__(self, PedidoID=0, NombrePropie="", platilloID=0, HoraEntrega=""):
    ...
    def __str__(self):  
        return f"{self.__pedidoID}{self.__NombrePropietario}{self.__platilloID}{self.__HoraEntrega}"
    ...
    def get_HoraEntrega(self):
        return self.__HoraEntrega
    def set_HoraEntrega(self, HoraEntrega):
        self.__HoraEntrega=HoraEntrega